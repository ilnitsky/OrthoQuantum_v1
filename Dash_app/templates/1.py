...
#
# im1 = Image.open('assets/images/Vertebrata.png')
# im2 = Image.open('assets/images/Vertebrata.png')
#
# print(type(im1))
# im2 = trim(im2)
#
...
rc = subprocess.call("imagemagick.sh")
# sns.set()
...
# if os.path.isfile('assets/images/concat_phylo.png') == True:
# os.remove('assets/images/concat_phylo.png')
#
#
# plt.savefig('assets/images/Presence.png')

concat_phylo('assets/images/Vertebrata.png', 'assets/images/out.png').save('assets/images/concat_phylo.png')
