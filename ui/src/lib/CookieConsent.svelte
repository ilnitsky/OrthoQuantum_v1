<script>
  ...
  // Can't be open at mount: issues with backdrop
  onMount(()=>{
  ...
  <Container fluid>
    <Row class="justify-content-center">
      ...
      <h3>Cookie consent</h3>
        <p>This website uses cookies to accomplish essential functionality. No user tracking across other
          websites for advertizing or other purposes is performed.</p>
          <Button color="success" on:click={give_consent}>I accept cookies</Button>
          <Button color="danger" class="float-end" href="https://en.wikipedia.org/wiki/HTTP_cookie">Leave</Button>
      </Col>
    </Row>
  </Container>
</Offcanvas>