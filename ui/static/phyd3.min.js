...
$jscomp.polyfill=function(d,b,a,e){if(b){a=$jscomp.global;d=d.split(".");for(e=0;e<d.length-1;e++){var f=d[e];f in a||(a[f]={});a=a[f]}d=d[d.length-1];e=a[d];b=b(e);b!=e&&null!=b&&$jscomp.defineProperty(a,d,{configurable:!0,writable:!0,value:b})}};$jscomp.FORCE_POLYFILL_PROMISE=!1;
$jscomp.polyfill("Promise",function(d){function b(){this.batch_=null}function a(a){return a instanceof f?a:new f(function(b,d){b(a)})}if(d&&!$jscomp.FORCE_POLYFILL_PROMISE)return d;b.prototype.asyncExecute=function(a){null==this.batch_&&(this.batch_=[],this.asyncExecuteBatch_());this.batch_.push(a);return this};b.prototype.asyncExecuteBatch_=function(){var a=this;this.asyncExecuteFunction(function(){a.executeBatch_()})};var e=$jscomp.global.setTimeout;b.prototype.asyncExecuteFunction=function(a){e(a,
0)};b.prototype.executeBatch_=function(){for(;this.batch_&&this.batch_.length;){var a=this.batch_;this.batch_=[];for(var b=0;b<a.length;++b){var d=a[b];delete a[b];try{d()}catch(I){this.asyncThrow_(I)}}}this.batch_=null};b.prototype.asyncThrow_=function(a){this.asyncExecuteFunction(function(){throw a;})};var f=function(a){this.state_=0;this.result_=void 0;this.onSettledCallbacks_=[];var b=this.createResolveAndReject_();try{a(b.resolve,b.reject)}catch(x){b.reject(x)}};f.prototype.createResolveAndReject_=
...
this.onSettledCallbacks_,b=0;b<a.length;++b)a[b].call(),a[b]=null;this.onSettledCallbacks_=null}};var n=new b;f.prototype.settleSameAsPromise_=function(a){var b=this.createResolveAndReject_();a.callWhenSettled_(b.resolve,b.reject)};f.prototype.settleSameAsThenable_=function(a,b){var d=this.createResolveAndReject_();try{a.call(b,d.resolve,d.reject)}catch(I){d.reject(I)}};f.prototype.then=function(a,b){function d(a,b){return"function"==typeof a?function(b){try{e(a(b))}catch(F){k(F)}}:b}var e,k,n=new f(function(a,
b){e=a;k=b});this.callWhenSettled_(d(a,e),d(b,k));return n};f.prototype.catch=function(a){return this.then(void 0,a)};f.prototype.callWhenSettled_=function(a,b){function d(){switch(e.state_){case 1:a(e.result_);break;case 2:b(e.result_);break;default:throw Error("Unexpected state: "+e.state_);}}var e=this;null==this.onSettledCallbacks_?n.asyncExecute(d):this.onSettledCallbacks_.push(function(){n.asyncExecute(d)})};f.resolve=a;f.reject=function(a){return new f(function(b,d){d(a)})};f.race=function(b){return new f(function(d,
e){for(var f=$jscomp.makeIterator(b),n=f.next();!n.done;n=f.next())a(n.value).callWhenSettled_(d,e)})};f.all=function(b){var d=$jscomp.makeIterator(b),e=d.next();return e.done?a([]):new f(function(b,f){function n(a){return function(d){k[a]=d;q--;0==q&&b(k)}}var k=[],q=0;do k.push(void 0),q++,a(e.value).callWhenSettled_(n(k.length-1),f),e=d.next();while(!e.done)})};return f},"es6","es3");
...
$jscomp.polyfill("String.prototype.startsWith",function(d){return d?d:function(b,a){var d=$jscomp.checkStringArgs(this,b,"startsWith");b+="";var f=d.length,n=b.length;a=Math.max(0,Math.min(a|0,d.length));for(var k=0;k<n&&a<f;)if(d[a++]!=b[k++])return!1;return k>=n}},"es6","es3");$jscomp.polyfill("Number.MAX_SAFE_INTEGER",function(){return 9007199254740991},"es6","es3");
$jscomp.iteratorFromArray=function(d,b){$jscomp.initSymbolIterator();d instanceof String&&(d+="");var a=0,e={next:function(){if(a<d.length){var f=a++;return{value:b(f,d[f]),done:!1}}e.next=function(){return{done:!0,value:void 0}};return e.next()}};e[Symbol.iterator]=function(){return e};return e};$jscomp.polyfill("Array.prototype.values",function(d){return d?d:function(){return $jscomp.iteratorFromArray(this,function(b,a){return a})}},"es8","es3");
(function(){"undefined"==typeof phyd3&&(phyd3={});phyd3.newick={};phyd3.newick.parse=function(d){var b=[],a={};d=d.split(/\s*(;|\(|\)|,|:)\s*/);for(var e=0,f=0;f<d.length;f++){var n=d[f];switch(n){case "(":n={};a.id=e;e++;a.branchset=[n];b.push(a);a=n;break;case ",":n={};b[b.length-1].branchset.push(n);a=n;break;case ")":a=b.pop();break;case ":":break;default:var k=d[f-1];")"==k||"("==k||","==k?a.name=n:":"==k&&(a.branchLength=parseFloat(n));a.id=e;e++}}return a}})();
if(!d3)throw"d3 wasn't included!";window.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||function(d){window.setTimeout(d,1E3/60)}}();window.renderPhyd3=function(d,b,a){return new Promise(function(e,f){d3.xml(d,function(d,f){try{if(null!=d)d3.select(b).text("Error");else{d3.select(b).html(null);var n=phyd3.phyloxml.parse(f);phyd3.phylogram.build(b,n,a)}}finally{e()}})})};
...
end:b[2]});!d.children&&b[2][0]>phyd3.phylogram.dx&&(phyd3.phylogram.dx=b[2][0]);return"M"+b[0]+" "+b[1]+" "+b[2]};phyd3.phylogram.scaleBranchLengths=function(d,b){function a(b,d){d(b);if(b.children)for(var e=b.children.length-1;0<=e;e--)a(b.children[e],d)}a(d[0],function(a){0>a.branchLength&&(a.branchLength*=-1);a.rootDist=(a.parent?a.parent.rootDist:0)+(a.branchLength||0)});var e=d.map(function(a){return a.rootDist}),f=d3.scale.linear().domain([0,d3.max(e)]).range([0,b]);a(d[0],function(a){a.y=
parseInt(f(a.rootDist))});return f};phyd3.phylogram.randomColor=function(){function d(a,b,d){0>d&&(d+=1);1<d&&--d;return d<1/6?a+6*(b-a)*d:.5>d?b:d<2/3?a+(b-a)*(2/3-d)*6:a}var b=Math.random();return function(a,b,f){if(0==b)f=b=a=f;else{var e=.5>f?f*(1+b):f+b-f*b,k=2*f-e;f=d(k,e,a+1/3);b=d(k,e,a);a=d(k,e,a-1/3)}return"#"+Math.round(255*f).toString(16)+Math.round(255*b).toString(16)+Math.round(255*a).toString(16)}((b+.618033988749895)%1,.5,.6)};phyd3.phylogram.scaledomainWidths=function(d,b){d=d.map(function(a){return a.sequences&&
a.sequences[0]&&a.sequences[0].domainArchitecture&&a.sequences[0].domainArchitecture.sequenceLength?a.sequences[0].domainArchitecture.sequenceLength:0});return d3.scale.linear().domain([0,d3.max(d)]).range([0,b])};phyd3.phylogram.build=function(d,b,a){function e(a){try{return a.parentNode.parentNode.getElementsByClassName("name")[0].textContent.trimEnd()}catch(v){return""}}function f(a){B.style("left",parseInt(a.clientX+5)+"px").style("top",parseInt(a.clientY+5)+"px")}function n(l,d){spName=e(l);
var g=d3.event;B.style("display","block").style("left",parseInt(g.clientX+5)+"px").style("top",parseInt(g.clientY+5)+"px");B.select("#popupSpecies").text(e(l));B.select("#popupProtein").text(b.graphs[0].legend.fields[d.i].name);var v;l.parentNode.parentNode.classList.forEach(function(a){a.startsWith("cid")&&(v=a.split("_")[1])});a.taskid_for_links&&B.select("#popupFASTA").attr("href","https://v101.orthodb.org/pgrest/rpc/fasta?id\x3d"+b.graphs[0].legend.fields[d.i].orthoid+"\x26species\x3d"+v);B.select("#popupInfo").text(d.label)}
function k(){null!==B&&B.style("display","none").text();null!==B&&ja.style("display","none");Y=!1;T&&(window.removeEventListener("mousemove",f),T=!1)}function q(a){d3.event.preventDefault();k()}function x(a){Y=!0;T&&(window.removeEventListener("mousemove",f),T=!1);n(this,a);ja.style("display","block")}function I(a){Y||(T||(window.addEventListener("mousemove",f),T=!0),null!==Z&&(clearTimeout(Z),Z=null),n(this,a))}function Ha(a){Y||(Z=setTimeout(function(){Z=null;Y||k()},150))}function S(){m.selectAll("text.groupLabel").remove();
m.selectAll("rect.groupLabel").remove();var l=0;for(gid in b.groups){var d=b.groups[gid];d.x1=Number.MAX_SAFE_INTEGER;d.x2=0;d.y1=Number.MAX_SAFE_INTEGER;d.y2=0;l<d.depth&&(l=d.depth);ua(b,d)}for(;0<=l;l--)for(gid in b.groups)d=b.groups[gid],d.depth==l&&(m.insert("text",":first-child").attr("class","groupLabel").attr("y",d.x1).attr("x",0).attr("dy",2*a.nodeHeight).attr("text-anchor","start").attr("stroke",d.foregroundColor).attr("stroke-width",a.outline+"px").attr("font-size",1.5*a.nodeHeight+"px").text(d.label),
m.insert("rect",":first-child").attr("class","groupLabel").attr("stroke",d.backgroundColor).attr("fill",d.backgroundColor).attr("y",d.x1).attr("height",d.x2-d.x1).attr("x",0).attr("width",phyd3.phylogram.dx).append("title").text(d.label))}function ia(a,d,g){if(g||a.id==d){g=!0;a.groupIDs||(a.groupIDs=[]);a.groupIDs.push(d);var l=b.groups[d];a.x<l.x1&&(l.x1=a.x);a.x>l.x2&&(l.x2=a.x);a.y<l.y1&&(l.y1=a.y);a.y>l.y2&&(l.y2=a.y)}if(a.children)for(l=0;l<a.children.length;l++)ia(a.children[l],d,g)}function ua(a,
b){if(a.groupIDs)for(var d=0;d<a.groupIDs.length;d++)a.groupIDs[d]==b.id&&(a.id==b.id&&(b.depth=a.depth),a.x<b.x1&&(b.x1=a.x),a.x>b.x2&&(b.x2=a.x),a.y<b.y1&&(b.y1=a.y),a.y>b.y2&&(b.y2=a.y));if(a.children)for(d=0;d<a.children.length;d++)ua(a.children[d],b)}function va(a,b){if(a.groupIDs){var d=a.groupIDs.indexOf(b);-1!=d&&a.groupIDs.splice(d,1)}if(a.children)for(d=0;d<a.children.length;d++)va(a.children[d],b)}function F(){d3.select(d).select("svg").remove();d3.select(d).html(null);svg=d3.select(d).insert("svg");
B=d3.select(d).append("div").attr("class","phyd3-popup").attr("id","popupId");ja=B.append("a").text("x").attr("href","#").style("display","none").style("position","absolute").style("top","-2px").style("right","6px").on("click",q);r=B.append("div");r.append("b").text("Species: ");r.append("span").attr("id","popupSpecies");r=B.append("div");r.append("b").text("Protein: ");r.append("span").attr("id","popupProtein");r=B.append("div");r.append("b").text("Info:");r.append("div").attr("id","popupInfo");
a.taskid_for_links&&r.append("a").attr("id","popupFASTA").text("FASTA");svg.attr("width",ca+"px").attr("height",a.height+"px").attr("overflow","hidden").attr("version","1.1").attr("font-family","Open Sans").attr("xmlns","http://www.w3.org/2000/svg").call(U);svg.append("svg:rect").attr("class","canvas").attr("width","100%").attr("height","100%").attr("fill",a.invertColors?a.foregroundColor:a.backgroundColor);svg.append("defs").append("marker").attr("id","markerBoxplot").attr("markerWidth","1").attr("markerHeight",
"10").attr("refX","1").attr("refY","5").append("line").attr("x1","0").attr("x2","0").attr("y1","0").attr("y2","10").attr("stroke",w()).attr("stroke-width","2px");m=svg.append("svg:g",":first-child").attr("id","main");svg.append("svg:text").attr("dy","20px").attr("class","title").attr("stroke",w()).attr("stroke-width","1px").attr("font-size","15px").text(b.name?b.name:"");svg.append("svg:text").attr("class","title").attr("dy","40px").attr("stroke",w()).attr("stroke-width","0.5px").attr("font-size",
"10px").text(b.description?b.description:"");V=m.selectAll("g.node");M();0==phyd3.phylogram.dx&&(d3.select("#phylogram").attr("checked","").attr("disabled","disabled"),a.showPhylogram=!0,M());y=m.selectAll("g.leaf.node");G=y.selectAll("g.domain");wa();ka();xa();la();ma();ya();za();V.append("svg:text").attr("class","name").attr("dx",a.nodeHeight+1).attr("dy",3).attr("text-anchor","start");da();aa();J();ea();C();S();var l=m[0][0].getBBox();m.attr("transform","translate("+(20-l.x)+", "+(20-l.y)+")")}
function Aa(){m.selectAll("rect.searchResults").remove();var a=jQuery("#searchQuery").val(),d=new RegExp(a,"i");a&&a.length&&Ba(b,d)}function w(){return a.invertColors?a.backgroundColor:a.foregroundColor}function na(){d3.selectAll(".canvas").attr("fill",a.invertColors?a.foregroundColor:a.backgroundColor);var b=w();m.selectAll("path.link").attr("stroke",b);d3.selectAll("text").attr("fill",b);d3.selectAll("marker").selectAll("line").attr("stroke",b);d3.selectAll("text.title").attr("stroke",b);m.selectAll("text.nodelabel").attr("stroke",
b).attr("fill",b);y.selectAll("path").attr("stroke",b);y.selectAll("line").attr("stroke",b);y.selectAll("rect").attr("stroke",b);da();oa()}function wa(){a.showDomains?(N=phyd3.phylogram.scaledomainWidths(D,a.domainWidth),y.append("svg:path").attr("class","domain").attr("stroke",w()).attr("visibility",function(a,b){return a.show?"visibile":"hidden"}),G=G.data(function(a,b,d){a=a.sequences&&a.sequences[0]&&a.sequences[0].domainArchitecture?a.sequences[0].domainArchitecture.domains:[];for(d=0;d<a.length;d++)a[d].i=
b;a.sort(function(a,b){return Math.abs(b.to-b.from)-Math.abs(a.to-a.from)});return a}).enter().append("svg:g").attr("class","domain"),G.append("svg:rect").attr("class","domain hover-visible").attr("stroke",w()).attr("stroke-width",a.outline+"px").append("title").text(function(a){return a.name}),fa(),K(),oa()):(G.remove(),y.selectAll("path.domain").remove(),G=y.selectAll("g.domain"))}function ka(){a.showDomainNames?(G.append("svg:text").attr("class","domain").attr("dy",-3).attr("fill",w()).attr("font-size",
1.5*a.nodeHeight+"px").text(function(a){return a.name}),K()):G.selectAll("text.domain").remove()}function fa(){var b=y.data();y.selectAll("g.domain").attr("visibility",function(d,l,e){return b[e].show&&d.confidence<=a.domainLevel?"visible":"hidden"});y.selectAll("path.domain").attr("visibility",function(a){return a.show?"visible":"hidden"});d3.select("#domainLevel").attr("value",a.domainLevel.toPrecision(1))}function oa(){G.selectAll("rect.domain").attr("fill",function(d){return a.showDomainColors&&
b.domcolors[d.name]?b.domcolors[d.name].color.replace(/0x/,"#"):w()})}function K(){var b=y.data(),d=O+(a.showLabels?P:0)+(a.showGraphs?t:0);N=phyd3.phylogram.scaledomainWidths(D,a.domainWidth);y.selectAll("path.domain").attr("d",function(a,l,e){l=phyd3.phylogram.dx-b[e].y;a=a.sequences&&a.sequences[0]&&a.sequences[0].domainArchitecture?a.sequences[0].domainArchitecture.sequenceLength:0;return"M"+parseInt(d+l)+",0L"+parseInt(d+l+N(a))+",0"});G.selectAll("rect.domain").attr("width",function(a){return parseInt(N(a.to-
a.from))}).attr("transform",function(l,e,v){return"translate("+parseInt(d+(phyd3.phylogram.dx-b[l.i].y)+N(l.from))+","+parseInt(-1*a.nodeHeight)+")"}).attr("height",2*a.nodeHeight-2);G.selectAll("text.domain").attr("transform",function(l){return"translate("+parseInt(d+(phyd3.phylogram.dx-b[l.i].y)+N(l.from))+","+parseInt(-1*a.nodeHeight)+")"});d3.select("#domainWidth").attr("value",a.domainWidth)}function la(){m.selectAll("text.supportValue").remove();a.showSupportValues&&(m.selectAll("g.inner.node").append("svg:text").attr("class",
"supportValue").attr("dx",-2).attr("text-anchor","end").attr("fill",a.supportValuesColor).text(function(b){var d="";if(b.confidences)for(var l=0;l<b.confidences.length;l++)d+=parseFloat(b.confidences[l].value).toFixed(a.maxDecimalsSupportValues)+" ";return d}),d3.select("#maxDecimalsSupportValues").attr("value",a.maxDecimalsSupportValues),C(),J())}function ma(){m.selectAll("text.branchLength").remove();a.showLengthValues&&(m.selectAll("g.node").append("svg:text").attr("class","branchLength").attr("dx",
-2).attr("text-anchor","end").attr("fill",a.branchLengthColor).text(function(b){return b.branchLength?parseFloat(b.branchLength).toFixed(a.maxDecimalsLengthValues):""}),d3.select("#maxDecimalsLengthValues").attr("value",a.maxDecimalsLengthValues),C(),J())}function ya(){a.lineupNodes?m.selectAll("g.leaf").append("path").attr("class","support").attr("stroke",w()).attr("stroke-dasharray","2,3").attr("stroke-width","0.5px"):m.selectAll("path.support").remove()}function ba(d,e){var l="";if(a.showTaxonomy&&
d.taxonomies)for(var v=0;v<d.taxonomies.length;v++){var h=d.taxonomies[v];a.showFullTaxonomy&&(l+=b.taxcolors[h.code]&&b.taxcolors[h.code].name?b.taxcolors[h.code].name:"",l+=" ",l+=h.scientificName?h.scientificName:"",l+=" ",l+=h.commonName?h.commonName:"",l+=" ");l+=h.code?h.code:"";l+=" "}v="";if(a.showSequences&&d.sequences)for(h=0;h<d.sequences.length;h++){var f=d.sequences[h];v+=f.symbol?f.symbol:"";v+=" ";v+=f.accession?f.accession.value:"";v+=" ";v+=f.name?f.name:"";v+=" ";v+=f.geneName?f.geneName:
"";v+=" ";if(f.annotations)for(var u=0;u<f.annotations.length;u++)text+=f.annotations[u].desc?f.annotations[u].desc:"",text+=" "}h=a.showNodeNames&&d.name?d.name+" ":" ";e||(d.children&&"only leaf"==a.showNodesType&&(h=" "),d.children||"only inner"!=a.showNodesType||(h=" "));return l+h+v}function aa(){var b=0;pa=0;y.selectAll("text.name").text(function(a){var d=ba(a);d.length>b&&(b=d.length,pa=a.id);return d});m.selectAll("g.node.inner").selectAll("text.name").text(ba);a.showGraphs&&W();a.showDomains&&
K()}function J(){m.selectAll("text.branchLength").attr("visibility",function(a){return a.show?"visible":"hidden"});m.selectAll("text.supportValues").attr("visibility",function(a){return a.show?"visible":"hidden"});m.selectAll("text.name").attr("visibility",function(a){return a.show?"visible":"hidden"});a.lineupNodes&&y.selectAll("path.support").attr("visibility",function(a){return a.show?"visible":"hidden"});a.showLabels&&Ca();a.showGraphs&&Da();a.showDomains&&fa()}function da(){m.selectAll("text.name").attr("stroke",
w()).attr("stroke-width",function(b){return-1!=a.pinnedNodes.indexOf(b.id)?2*a.outline+"px":a.outline+"px"}).attr("fill",function(d){var l=null;if(a.showTaxonomyColors&&b.taxcolors&&d.taxonomies)for(var g=0;g<d.taxonomies.length;g++){var e=d.taxonomies[g];b.taxcolors[e.code]&&b.taxcolors[e.code].color&&(l=b.taxcolors[e.code].color.replace(/0x/,"#"))}return l?l:w()})}function Ea(){y.selectAll("text.name").attr("dx",function(b){return parseInt(a.lineupNodes?phyd3.phylogram.dx-b.y+5:5)});y.selectAll("path.support").attr("d",
function(a){return"M0,0 L"+parseInt(phyd3.phylogram.dx-a.y)+",0"});a.showLabels&&qa();a.showGraphs&&W();a.showDomains&&K()}function C(){var b=0;m.selectAll("text.name").attr("dy",a.nodeHeight/2).attr("font-size",1.5*a.nodeHeight+"px");m.selectAll("text.branchLength").attr("dy",-a.nodeHeight/2).attr("font-size",1.5*a.nodeHeight+"px");m.selectAll("text.supportValue").attr("dy",a.nodeHeight/2+5).attr("font-size",1.5*a.nodeHeight+"px");a.showNodeNames&&"only inner"!=a.showNodesType?(m.selectAll("g.leaf.cid_"+
pa).selectAll("text.name").each(function(){var a=this.getBBox();a.width>b&&(b=a.width)}),b+=10,b<a.textLength&&(b=a.textLength)):b=5;O=b;d3.select("#nodeHeight").attr("value",2*a.nodeHeight+"px");Ea();a.showLabels&&qa();a.showGraphs&&W();a.showDomains&&K()}function za(){if(a.showLabels&&b.labels){for(var d=0;d<b.labels.length;d++){var e=b.labels[d];e.id||(e.id=parseInt(Date.now()*Math.random()*1E3));e.data.tag&&m.selectAll("g.node").each(function(a){var b=a[e.data.tag],d=e.data.ref;d=d?d:"value";
b="object"==typeof b?b[d]:b;if("property"==e.data.tag)for(pid=0;pid<a.properties.length;pid++){var l=a.properties[pid];if(l.ref==d){b=l.value;break}}b&&(e.data[a.id]=b)});switch(e.type){case "text":for(cid in e.data)e.data[cid]&&m.selectAll(".cid_"+cid).append("text").attr("class","nodelabel text lid"+e.id).attr("dy",3).attr("text-anchor","start").attr("stroke-width",a.outline+"px").attr("stroke",w()).attr("fill",w()).attr("font-size",1.5*a.nodeHeight+"px").text(e.data[cid]).append("title").text(e.name+
": "+e.data[cid]);break;case "color":for(cid in e.data)if(e.data[cid]){var g=a.nodeHeight,f=e.data[cid].replace(/0x/,"#");m.selectAll(".cid_"+cid).append("rect").attr("height",2*g).attr("width",2*g).attr("class","nodelabel color lid"+e.id).attr("style","fill: "+f+"; stroke: "+f).append("title").text(e.name)}}m.append("text").attr("class","labellegend lid"+e.id).attr("fill",w()).text(0!=e.showLegend?e.name:"")}Ca();qa()}else m.selectAll(".nodelabel").remove(),m.selectAll(".labellegend").remove(),P=
0;W();K()}function qa(){var d=parseInt(a.nodeHeight);P=0;if(b.labels){for(var e=0;e<b.labels.length;e++){var g=b.labels[e],f=0;m.selectAll(".nodelabel.lid"+g.id).attr("transform",function(a){var b=0,e=0;"color"==g.type&&(b=e=-d);var l=0;"text"==this.nodeName&&this.firstChild?l=this.firstChild.length*d/1.5:"rect"==this.nodeName&&(l=2*d);l>f&&(f=l);a.branchset.length?(b+=a.y,b-=d):b+=phyd3.phylogram.dx+O;return"translate("+parseInt(b+d+P-a.y)+","+e+")"});m.selectAll("text.labellegend.lid"+g.id).attr("transform",
"translate("+parseInt(phyd3.phylogram.dx+P+O+2*d)+",-10) rotate(-90)").attr("font-size",2*d+"px");P+=f+2*d}y.selectAll("text.nodelabel").attr("dy",d/2).attr("font-size",1.5*d+"px");y.selectAll("rect.nodelabel").attr("width",2*d+"px").attr("height",2*d+"px")}}function Ca(){m.selectAll(".nodelabel").attr("visibility",function(a){return a.show?"visible":"hidden"})}function xa(){if(a.showGraphs&&b.graphs&&b.graphs.length){d3.svg.arc().innerRadius(0).outerRadius(a.nodeHeight);for(var d=d3.layout.pie().value(function(a){return a.value}).sort(null),
e=t=0;e<b.graphs.length;e++){var g=b.graphs[e];g.id||(g.id=parseInt(Date.now()*Math.random()*1E3));if(g.data.tag)var f=m.selectAll("g.node").each(function(a){var b=a[g.data.tag],d=g.data.ref;d=d?d:"value";b="object"==typeof b?b[d]:b;if("property"==g.data.tag)for(var e=0;e<a.properties.length;e++){var l=a.properties[e];if(l.ref==d){b=l.value;break}}b&&(g.data[a.id]=[],g.data[a.id][0]=b,"pie"==g.type&&g.data.max&&(g.data[a.id][1]=g.data.max-b,g.legend.fields[1]={name:g.legend.fields[0].name,color:g.legend.fields[0].background?
g.legend.fields[0].background:phyd3.phylogram.randomColor(),invert:!0}))});switch(g.type){case "pie":for(cid in g.data)if(f=cid.replace(/\./g,"\\."),g.data[cid]&&Array.isArray(g.data[cid])){var h=!1;m.select(".cid_"+f).each(function(a){0==a.branchset.length&&(h=!0)});f=m.selectAll(".cid_"+f).append("svg:g").attr("class","graph pie gid"+g.id);for(var p=[],u=0;u<g.data[cid].length;u++)void 0!=g.data[cid][u]&&p.push({i:u,value:g.data[cid][u],leaf:h});p=f.selectAll("path.pie.gid"+g.id).data(d(p)).enter().append("path").attr("class",
"pie hover-visible gid"+g.id).attr("stroke",w()).attr("stroke-width",a.outline+"px").attr("fill",function(a,b){return g.legend.fields?(g.legend.fields[b]||(g.legend.fields[b]={},g.legend.fields[b].name="Series "+(b+1),g.legend.fields[b].color=phyd3.phylogram.randomColor()),g.legend.fields[b].color.replace(/0x/,"#")):""}).append("title").text(function(a,b){return g.legend.fields?(g.legend.fields[b]&&g.legend.fields[b].name?g.legend.fields[b].name+": ":"")+(g.legend.fields[b].invert?g.data.max-a.data.value:
a.data.value):""})}break;case "binary":for(cid in g.data)if(g.data[cid]&&Array.isArray(g.data[cid])){f=cid.replace(/\./g,"\\.");p=[];h=!1;m.select(".cid_"+f).each(function(a){0==a.branchset.length&&(h=!0)});f=m.selectAll(".cid_"+cid).append("svg:g").attr("class","graph binary gid"+g.id);for(u=0;u<g.data[cid].length;u++)void 0!=g.data[cid][u]&&p.push({i:u,value:g.data[cid][u],shape:g.legend.fields[u]?g.legend.fields[u].shape:"",leaf:h});p=f.selectAll("path.binary.gid"+g.id).data(p).enter().append("path").attr("class",
"binary hover-visible gid"+g.id).attr("style",function(a,b){b=(g.legend.fields[b]?g.legend.fields[b].color:"").replace(/0x/,"#");return"fill:"+(1<=a.value?b:"none")+";stroke:"+(0<=a.value?b:"none")}).append("title").text(function(a,b){return(g.legend.fields[b]?g.legend.fields[b].name+": ":"")+a.value})}break;case "multibar":z[g.id]=[];for(u=0;u<g.legend.fields.length;u++)p=d3.max(d3.values(g.data),function(a){if(a)return a[u]}),f=d3.min(d3.values(g.data),function(a){if(a)return a[u]}),0<f&&(f=0),
z[g.id][u]=d3.scale.linear().domain([f,p]);for(cid in g.data)if(g.data[cid]){f=cid.replace(/\./g,"\\.");f=m.select(".cid_"+f).append("svg:g").attr("class","graph multibar gid"+g.id);p=[];for(u=0;u<g.data[cid].length;u++)void 0!=g.data[cid][u]&&p.push({i:u,value:g.data[cid][u]});p=f.selectAll("rect.multibar.gid"+g.id).data(p).enter().append("rect").attr("class","multibar hover-visible gid"+g.id).attr("fill",function(a,b){return(g.legend.fields[b]?g.legend.fields[b].color:"").replace(/0x/,"#")}).attr("stroke",
w()).attr("stroke-width",a.outline).append("title").text(function(a,b){return(g.legend.fields[b]?g.legend.fields[b].name+": ":"")+a.value})}break;case "boxplot":A[g.id]=null;var k=0,ra=Number.MAX_SAFE_INTEGER;for(u=0;5>u;u++)p=d3.max(d3.values(g.data),function(a){if(a)return a[u]}),f=d3.min(d3.values(g.data),function(a){if(a)return a[u]}),p>k&&(k=p),f<ra&&(ra=f);A[g.id]=d3.scale.linear().domain([ra,k]);for(cid in g.data)g.data[cid]&&(f=cid.replace(/\./g,"\\."),f=m.select(".cid_"+f).append("svg:g").attr("class",
"graph boxplot gid"+g.id),p=[],p.push({min:g.data[cid][0],q1:g.data[cid][1],median:g.data[cid][2],q3:g.data[cid][3],max:g.data[cid][4]}),p=f.selectAll("rect.boxplot.gid"+g.id).data(p).enter(),p.append("line").attr("class","boxplot baseline hover-visible gid"+g.id).attr("style","marker-start: url(#markerBoxplot); marker-end: url(#markerBoxplot);").attr("stroke",w()),p.append("rect").attr("class","boxplot q1 hover-visible gid"+g.id).attr("fill",(g.legend.fields[0]?g.legend.fields[0].color:"").replace(/0x/,
"#")).attr("stroke",w()).attr("stroke-width",a.outline).append("title").text(function(a){return"Min: "+a.min+", Q1: "+a.q1+", Median: "+a.median}),p.append("rect").attr("class","boxplot q3 hover-visible gid"+g.id).attr("fill",(g.legend.fields[1]?g.legend.fields[1].color:"").replace(/0x/,"#")).attr("stroke",w()).attr("stroke-width",a.outline).append("title").text(function(a){return"Median: "+a.median+", Q3: "+a.q3+", Max: "+a.max}),p.append("line").attr("class","boxplot median hover-visible gid"+g.id).attr("stroke",
w()).attr("stroke-width","2px"));break;case "heatmap":p=100;f=0;var n=d3.scale.quantize().domain([f,p]).range(colorbrewer[g.legend.gradient.name][g.legend.gradient.classes]);for(cid in g.data)if(g.data[cid]){f=cid.replace(/\./g,"\\.");f=m.select(".cid_"+f).append("svg:g").attr("class","graph heatmap gid"+g.id);p=[];if(g.data[cid])for(u=0;u<g.data[cid].length;u++)void 0!=g.data[cid][u]&&p.push({i:u,value:g.data[cid][u].value,label:g.data[cid][u].label});p=f.selectAll("rect.heatmap.gid"+g.id).data(p).enter().append("rect").attr("class",
"heatmap hover-visible gid"+g.id).attr("stroke",function(b,d){return isNaN(b.value)?a.nanColor:w()}).attr("stroke-width",a.outline+"px").on("mouseover",I).on("mouseout",Ha).on("click",x)}d3.selectAll("rect.heatmap").attr("fill",function(b,d){return isNaN(b.value)?a.nanColor:n(b.value)});break;default:console.log("Graph not supported "+g.type)}}Da();W()}else t=0,m.selectAll("g.graph").remove(),m.selectAll("text.legend").remove();K()}function W(){var d=a.nodeHeight,e=O+P;y.selectAll("g.graph").attr("transform",
function(a){return"translate("+(phyd3.phylogram.dx-a.y+e)+",0)"});var g=m.selectAll("g.graph");d3.select("#graphWidth").attr("value",a.graphWidth);m.selectAll("text.legend").remove();t=0;if(b.graphs){for(var f=0;f<b.graphs.length;f++){var h=b.graphs[f];switch(h.type){case "pie":g.selectAll("path.pie.gid"+h.id).attr("d",function(a){if(0<a.value)return d3.svg.arc().innerRadius(0).outerRadius(d)(a)}).attr("transform",function(a){return" translate("+parseInt(a.data.leaf?d+t:0)+",0)"});a.showGraphs&&a.showGraphLegend&&
m.append("text").attr("class","legend").text(0!=h.legend.show?h.name:"").attr("transform","translate("+parseInt(phyd3.phylogram.dx+e+t+2*d)+",-10) rotate(-90)");t+=2*d+5;break;case "binary":g.selectAll("path.binary.gid"+h.id).attr("d",function(a){var b=d3.svg.symbol().size(4*(d-2)*(d-2));b.type(h.legend.fields[a.i].shape);return b(a)}).attr("transform",function(a){return" translate("+(a.leaf?t+10+a.i*(2*d+5):0)+" ,0)"});if(a.showGraphs&&a.showGraphLegend)for(var p=0;p<h.legend.fields.length;p++)m.append("text").attr("class",
"legend").text(0!=h.legend.show?h.legend.fields[p].name:"").attr("transform","translate("+(phyd3.phylogram.dx+e+t+p*(2*d+5)+2*d)+", -10) rotate(-90)");t+=10+h.legend.fields.length*(2*d+5);break;case "multibar":for(p=0;p<h.legend.fields.length;p++)z[h.id][p]=z[h.id][p].range([0,a.graphWidth]);g.selectAll("rect.multibar.gid"+h.id).attr("height",h.legend.stacked?parseInt(2*d/h.legend.fields.length):parseInt(2*d)).attr("width",function(a,b){b=parseInt(z[h.id]&&z[h.id][a.i]?z[h.id][a.i](a.value):0);a=
parseInt(z[h.id]&&z[h.id][a.i]?z[h.id][a.i](0):0);return b>a?b-a:a-b}).attr("transform",function(b,e){e=t;var g=-1*d;h.legend.stacked?g+=2*d/h.legend.fields.length*b.i:e+=b.i*(a.graphWidth+5);var l=parseInt(z[h.id]&&z[h.id][b.i]?z[h.id][b.i](b.value):0);b=parseInt(z[h.id]&&z[h.id][b.i]?z[h.id][b.i](0):0);return" translate("+parseInt(e+(b<l?b:l))+", "+parseInt(g)+")"});if(a.showGraphs&&a.showGraphLegend)if(h.legend.stacked)m.append("text").attr("class","legend").text(0!=h.legend.show?h.name:"").attr("transform",
"translate("+(phyd3.phylogram.dx+e+t+a.graphWidth/2)+",-10) rotate(-90)");else for(p=0;p<h.legend.fields.length;p++)m.append("text").attr("class","legend").text(0!=h.legend.show?h.legend.fields[p].name:"").attr("transform","translate("+(phyd3.phylogram.dx+e+t+p*(a.graphWidth+5)+a.graphWidth/2)+",-10) rotate(-90)");t+=(h.legend.stacked?1:h.legend.fields.length)*(a.graphWidth+5);break;case "boxplot":A[h.id]=A[h.id].range([0,a.graphWidth]);g.selectAll("rect.q1.boxplot.gid"+h.id).attr("height",parseInt(2*
d)).attr("width",function(a){return parseInt(A[h.id](a.median)-A[h.id](a.q1))}).attr("transform",function(a,b){a=t+A[h.id](a.q1);return" translate("+parseInt(a)+",-"+parseInt(d)+")"});g.selectAll("rect.q3.boxplot.gid"+h.id).attr("height",parseInt(2*d)).attr("width",function(a){return parseInt(A[h.id](a.q3)-A[h.id](a.median))}).attr("transform",function(a,b){a=t+A[h.id](a.median);return" translate("+parseInt(a)+",-"+parseInt(d)+")"});g.selectAll("line.baseline.boxplot.gid"+h.id).attr("y1",parseInt(d)).attr("y2",
parseInt(d)).attr("x1",function(a){var b=A[h.id](a.min);0>b&&console.log(a.min,b);return A[h.id](a.min)}).attr("x2",function(a){return A[h.id](a.max)}).attr("transform",function(a,b){return" translate("+parseInt(t)+",-"+parseInt(d)+")"});g.selectAll("line.median.boxplot.gid"+h.id).attr("y1",0).attr("y2",parseInt(2*d)).attr("x1",function(a){return A[h.id](a.median)}).attr("x2",function(a){return A[h.id](a.median)}).attr("transform",function(a,b){return" translate("+parseInt(t)+",-"+parseInt(d)+")"});
a.showGraphs&&a.showGraphLegend&&m.append("text").attr("class","legend").text(0!=h.legend.show?h.name:"").attr("transform","translate("+(phyd3.phylogram.dx+e+t+2*d)+", -10) rotate(-90)");t+=a.graphWidth+5;break;case "heatmap":g.selectAll("rect.heatmap.gid"+h.id).attr("width",2*d).attr("height",2*d).attr("transform",function(a,b){return" translate("+(t+2*a.i*d)+",-"+d+")"});if(a.showGraphs&&a.showGraphLegend)for(p=0;p<h.legend.fields.length;p++){var k=0!=h.legend.show?h.legend.fields[p].name:"";if(a.taskid_for_links){var n=
m.append("a");n.attr("xlink:href","/prottree?task_id\x3d"+a.taskid_for_links+"\x26prot_id\x3d"+k)}else n=m;n.append("text").attr("class","legend").attr("transform","translate("+parseInt(phyd3.phylogram.dx+e+t+(p+1)*d*2)+",-10) rotate(-90)").text(k)}t+=2*h.legend.fields.length*d+5}}m.selectAll("text.legend").attr("fill",w()).attr("font-size",2*a.nodeHeight+"px")}}function Ia(){var d=a.nodeHeight;t=0;if(b.graphs)for(var e=0;e<b.graphs.length;e++){var g=b.graphs[e];switch(g.type){case "pie":t+=2*d+5;
break;case "binary":t+=(g.legend.fields.length+1)*(2*d+5)+5;break;case "multibar":t+=g.legend.fields.length*(a.graphWidth+5);break;case "heatmap":t+=2*g.legend.fields.length*d+5}}return 2*a.margin+(a.showNodeNames?O:0)+(a.showGraphs?t:0)+(a.showDomains?a.domainWidth:0)}function Da(){var b=[],d=function(d){if(!a.dynamicHide)return"visible";for(var e=!0,g=a.nodeHeight,f=d.x,l=d.y,v=0;v<b.length;v++){var k=b[v].x,m=b[v].y;if((k-f)*(k-f)+(m-l)*(m-l)<=4*g*g){e=!1;break}}return e?(b.push(d),"visible"):
"hidden"};y.selectAll("g.graph").attr("visibility",function(a){return a.show?"visible":"hidden"});m.selectAll("g.inner").selectAll(".graph.pie").attr("visibility",d);m.selectAll("g.inner").selectAll(".graph.binary").attr("visibility",d)}function M(d,e){phyd3.phylogram.lineAreas=[];phyd3.phylogram.dx=0;var g=d3.layout.cluster().separation(function(a,b){return 1}).children(a.children||function(a){return a.branchset}).size([Q*a.scaleY,L*a.scaleX]);D=g(b);for(e=0;e<D.length;e++){var f=D[e];void 0!==f.taxonomies&&
0!==f.taxonomies.length&&(b.groups[f.id]={id:f.id,depth:f.depth,label:"",foregroundColor:b.taxcolors[f.taxonomies[0].code].color.replace("0x","#"),backgroundColor:a.invertColors?a.foregroundColor:a.backgroundColor},ia(b,f.id))}a.showPhylogram||phyd3.phylogram.scaleBranchLengths(D,L*a.scaleX);e=m.selectAll("path.link");d||(e=e.data(g.links(D)),e.enter().append("svg:path").attr("class","link").attr("fill","none").attr("stroke",function(a){if(a.source.groupIDs&&a.source.groupIDs.length){for(var d={depth:0},
e=0;e<a.source.groupIDs.length;e++){var g=b.groups[a.source.groupIDs[e]];g&&g.depth>=d.depth&&(d=g)}return d.foregroundColor}return w()}));e.attr("d",phyd3.phylogram.rightAngleDiagonal);E=void 0;c=0;f=D.filter(function(a){return!a.children});for(e=0;e<f.length;e++)(g=-1!=a.pinnedNodes.indexOf(f[e].id))?(f[e].show=!0,f[e].pinned=!0,ha(f[e],!a.lineupNodes)||(E.show=E.pinned?!0:!1),E=f[e]):f[e].show=a.dynamicHide?ha(f[e],!a.lineupNodes):!0;E=void 0;f=D.filter(function(a){return a.children});for(e=0;e<
f.length;e++)(g=-1!=a.pinnedNodes.indexOf(f[e].id))?(f[e].show=!0,f[e].pinned=!0,ha(f[e],!0)||(E.show=E.pinned?!0:!1),E=f[e]):f[e].show=a.dynamicHide?ha(f[e],!0):!0;d||(V=V.data(D),V.enter().append("svg:g").attr("class",function(a){return a.children?0==a.depth?"root node cid_"+a.id:"inner node cid_"+a.id:"leaf node cid_"+a.id}).on("click",function(d){var e=d3.event;!e.ctrlKey||e.altKey||e.shiftKey?!e.altKey||e.ctrlKey||e.shiftKey||(Ga(b,d.id),k(),a.domainWidth=a.domainWidthStep,a.graphWidth=a.initialGraphWidth,
a.scaleX=1,a.scaleY=1,a.translateX=0,a.translateY=0,U.translate([0,0]),F()):(Fa(b,d.id),S(),F())}).style("z-index",100).append("rect").attr("class","pointer").attr("fill","red").attr("width",2*a.nodeHeight+2+"px").attr("height",2*a.nodeHeight+2+"px").style("opacity","0").attr("x","-"+(a.nodeHeight+1)+"px").attr("y","-"+(a.nodeHeight+1)+"px"));V.attr("transform",function(a){return"translate("+parseInt(a.y)+","+parseInt(a.x)+")"});phyd3.phylogram.lineAreas=[]}function Ba(b,d){if(ba(b,!0).match(d)){var e=
!b.children&&a.lineupNodes?phyd3.phylogram.dx-b.y:0;m.selectAll("g.node.cid_"+b.id).append("rect").attr("class","searchResults").attr("width",O+"px").attr("height",2*a.nodeHeight+2+"px").attr("fill","yellow").style("opacity","0.3").attr("x",e+"px").attr("y","-"+(a.nodeHeight+1)+"px")}if(b.children)for(e=0;e<b.children.length;e++)r=Ba(b.children[e],d);return!1}function Fa(a,b,d){if(d||a.id==b)d=!0,a.branchset=a.branchset.reverse();if(a.children)for(var e=0;e<a.children.length;e++)Fa(a.children[e],
b,d)}function Ga(a,d){if(a.id==d)b.branchset=[a];else if(a.children)for(var e=0;e<a.children.length;e++)Ga(a.children[e],d)}function R(){M(!0);ea()}function ha(b,d){var e=!0,f=b.y+1,l=b.y+5.5*ba(b,!0).length,k=b.x-a.nodeHeight,m=b.x+a.nodeHeight;if(!E)return E=b,!0;a.lineupNodes&&!b.children&&(f+=phyd3.phylogram.dx-b.y,l+=phyd3.phylogram.dx-b.y);var v=E,n=v.y+1,t=v.y+5.5*ba(v,!0).length,q=v.x-a.nodeHeight,w=v.x+a.nodeHeight;a.lineupNodes&&!v.children&&(n+=phyd3.phylogram.dx-v.y,t+=phyd3.phylogram.dx-
v.y);if(n<=f&&f<=t&&q<=k&&k<=w||n<=l&&l<=t&&q<=k&&k<=w||n<=f&&f<=t&&q<=m&&m<=w||n<=l&&l<=t&&q<=m&&m<=w)e=!1;if(e&&d)for(d=0;d<phyd3.phylogram.lineAreas.length;d++)if(q=phyd3.phylogram.lineAreas[d],v=q.start[0],n=q.end[0],t=q.start[1],q=q.end[1],t==q){if(k<=t&&q<=m&&!(v>l||n<f)){e=!1;break}}else if(v==n&&f<=v&&n<=l&&!(t>m||q<k)){e=!1;break}e&&(E=b);return e}function ea(){k();var b=U.translate(),d=b[0]+a.marginX-a.translateX,e=b[1]+a.marginY-a.translateY;m.attr("transform",function(a){return"translate("+
parseInt(d)+","+parseInt(e)+") scale(1)"});0!=a.lastScale&&(Ea(),a.dynamicHide&&J());Aa();S()}var B=null,ja=null,Y=!1,Z=null,T=!1;a=a||{};a.scaleY=a.scaleY||1;a.origScaleY=a.origScaleY||1;a.scaleX=a.scaleX||1;a.origScaleX=a.origScaleX||1;a.translateX=a.translateX||0;a.translateY=a.translateY||0;a.height=a.height||800;a.margin=a.margin||20;a.scaleStep=a.scaleStep||.3;a.nodeHeight=a.nodeHeight||6;a.nodeHeightStep=a.nodeHeightStep||1;a.textLength=a.textLength||100;a.domainWidth=a.domainWidth||100;a.domainWidthStep=
...
!1;a.pinnedNodes=a.pinnedNodes||[];a.taskid_for_links=a.taskid_for_links||"";b.groups=b.groups?b.groups:{};var m,V,y,G,D,N,E,A=[],z=[],P=100,O=100,t=0,X=100,pa=0,sa=jQuery.extend(!0,{},b),H=!1;if(b.graphs)for(var ta=0;ta<b.graphs.length;ta++)if(0!=b.graphs[ta].legend.show){H=!0;break}X=H?X:0;a.marginX=a.margin;a.marginY=a.margin+(a.showGraphs?X:0);a.initialGraphWidth=a.graphWidth;var ca=jQuery(d).width(),L="auto"==a.treeWidth?ca-Ia():a.treeWidth,Q=a.height-(2*a.margin+(a.showGraphs?X:0));L=parseInt(L);
Q=parseInt(Q);0>L&&(L=ca-2*O-(a.showGraphs?2*X:0));var U=d3.behavior.zoom().scaleExtent([1,1]).on("zoom",function(b){b=0;var d=d3.event.sourceEvent;if(d){if(0<d.deltaY||0>d.wheelDelta)b=-1*a.scaleStep;if(0>d.deltaY||0<d.wheelDelta)b=a.scaleStep;var e=.5,f=.5;d.altKey||d.ctrlKey?d.altKey&&d.ctrlKey&&(e=d.layerX/ca,f=d.layerY/a.height):a.translateY-=Q*b*f;d.ctrlKey&&(a.scaleY+=b,a.scaleY<a.scaleStep?a.scaleY=a.scaleStep:a.translateY+=Q*b*f);d.altKey&&(a.graphWidth+=0==b?0:0>b?-10:10,10>a.graphWidth&&
(a.graphWidth=10),a.domainWidth+=0==b?0:0>b?-1*a.domainWidthStep:a.domainWidthStep,a.domainWidth<a.domainWidthStep&&(a.domainWidth=a.domainWidthStep),a.scaleX+=b,a.scaleX<a.scaleStep?a.scaleX=a.scaleStep:a.translateX+=L*b*e);a.lastScale=b;0!=a.lastScale?requestAnimFrame(R):requestAnimFrame(ea)}});d3.select("#invertColors").on("click",function(){a.invertColors=!a.invertColors;na()});jQuery("#foregroundColorButton").colorpicker().on("changeColor",function(){a.foregroundColor=jQuery("#foregroundColor").val();
na()});jQuery("#backgroundColorButton").colorpicker().on("changeColor",function(){a.backgroundColor=jQuery("#backgroundColor").val();na()});d3.select("#nodesType").on("change",function(){a.showNodesType=jQuery(this).val();R();aa()});d3.select("#phylogram").on("click",function(){a.showPhylogram=!a.showPhylogram;M(!0);C();J()});d3.select("#lineupNodes").on("click",function(){a.lineupNodes=!a.lineupNodes;M(!0);ya();C();J()});d3.select("#lengthValues").on("click",function(){a.showLengthValues=!a.showLengthValues;
a.showLengthValues?d3.select("#maxDecimalsLengthValues").attr("disabled",null):d3.select("#maxDecimalsLengthValues").attr("disabled","disabled");ma()});d3.select("#maxDecimalsLengthValues").on("change",function(){a.maxDecimalsLengthValues=jQuery(this).val();ma()});d3.select("#supportValues").on("click",function(){a.showSupportValues=!a.showSupportValues;a.showSupportValues?d3.select("#maxDecimalsSupportValues").attr("disabled",null):d3.select("#maxDecimalsSupportValues").attr("disabled","disabled");
la()});d3.select("#maxDecimalsSupportValues").on("change",function(){a.maxDecimalsSupportValues=jQuery(this).val();la()});phyd3.phylogram.updateNodeVisibility=function(b,d){a.showNodeNames=b||d;oldShowNodesType=a.showNodesType;b&&d?a.showNodesType="all":b?a.showNodesType="only inner":d&&(a.showNodesType="only leaf");oldShowNodesType!=a.showNodesType&&R();aa();C()};phyd3.phylogram.dynamicHide=function(b){a.dynamicHide=b;M(!0);J()};d3.select("#nodeLabels").on("click",function(){a.showLabels=!a.showLabels;
za()});d3.select("#taxonomy").on("click",function(){a.showTaxonomy=!a.showTaxonomy;aa();C()});d3.select("#sequences").on("click",function(){a.showSequences=!a.showSequences;aa();C()});d3.select("#taxonomyColors").on("click",function(){a.showTaxonomyColors=!a.showTaxonomyColors;da()});d3.select("#nodeHeightLower").on("click",function(){a.nodeHeight-=a.nodeHeightStep;a.nodeHeight<a.nodeHeightStep&&(a.nodeHeight=a.nodeHeightStep);M(!0);C();J();S()});d3.select("#nodeHeightHigher").on("click",function(){a.nodeHeight+=
a.nodeHeightStep;M(!0);C();J();S()});phyd3.phylogram.resetZoom=function(){b=jQuery.extend(!0,{},sa);a.scaleX=a.origScaleX;a.scaleY=a.origScaleY;a.translateX=0;a.translateY=0;U.translate([0,0]);F()};phyd3.phylogram.fitTree=function(){b=jQuery.extend(!0,{},sa);a.scaleX=a.origScaleX;a.scaleY=1;a.translateX=0;a.translateY=0;U.translate([0,0]);F()};phyd3.phylogram.resetPos=function(){b=jQuery.extend(!0,{},sa);a.translateX=0;a.translateY=0;U.translate([0,0]);F()};d3.select("#zoominY").on("click",function(){a.scaleY+=
a.scaleStep;a.translateY+=Q*a.scaleStep/2;a.lastScale=a.scaleStep;requestAnimFrame(R)});d3.select("#zoomoutY").on("click",function(){a.scaleY-=a.scaleStep;a.scaleY<a.scaleStep?a.scaleY=a.scaleStep:a.translateY-=Q*a.scaleStep/2;a.lastScale=-1*a.scaleStep;requestAnimFrame(R)});d3.select("#zoominX").on("click",function(){a.scaleX+=a.scaleStep;a.translateX+=L*a.scaleStep/2;a.lastScale=a.scaleStep;requestAnimFrame(R)});d3.select("#zoomoutX").on("click",function(){a.scaleX-=a.scaleStep;a.scaleX<a.scaleStep?
a.scaleX=a.scaleStep:a.translateX-=L*a.scaleStep/2;a.lastScale=-1*a.scaleStep;requestAnimFrame(R)});d3.select("#domains").on("click",function(){a.showDomains=!a.showDomains;a.showDomains?(d3.select("#domainNames").attr("disabled",null),d3.select("#domainColors").attr("disabled",null),d3.select("#domainWidthLower").attr("disabled",null),d3.select("#domainWidthHigher").attr("disabled",null),d3.select("#domainLevelLower").attr("disabled",null),d3.select("#domainLevelHigher").attr("disabled",null)):(d3.select("#domainNames").attr("disabled",
"disabled"),d3.select("#domainColors").attr("disabled","disabled"),d3.select("#domainWidthLower").attr("disabled","disabled"),d3.select("#domainWidthHigher").attr("disabled","disabled"),d3.select("#domainLevelLower").attr("disabled","disabled"),d3.select("#domainLevelHigher").attr("disabled","disabled"));wa();ka()});d3.select("#domainColors").on("click",function(){a.showDomainColors=!a.showDomainColors;oa()});d3.select("#domainNames").on("click",function(){a.showDomainNames=!a.showDomainNames;ka()});
d3.select("#domainWidthLower").on("click",function(){a.domainWidth-=a.domainWidthStep;a.domainWidth<a.domainWidthStep&&(a.domainWidth=a.domainWidthStep);N=phyd3.phylogram.scaledomainWidths(D,a.domainWidth);K()});d3.select("#domainWidthHigher").on("click",function(){a.domainWidth+=a.domainWidthStep;N=phyd3.phylogram.scaledomainWidths(D,a.domainWidth);K()});d3.select("#domainLevelLower").on("click",function(){a.domainLevel/=a.domainLevelStep;fa()});d3.select("#domainLevelHigher").on("click",function(){a.domainLevel*=
a.domainLevelStep;fa()});d3.select("#graphLegend").on("click",function(){a.showGraphLegend=!a.showGraphLegend;a.marginY=a.margin+(a.showGraphs?X:0);W();ea()});d3.select("#graphs").on("click",function(){a.showGraphs=!a.showGraphs;a.showGraphs?(d3.select("#graphLegend").attr("disabled",null),d3.select("#graphWidthLower").attr("disabled",null),d3.select("#graphWidthHigher").attr("disabled",null)):(d3.select("#graphLegend").attr("disabled","disabled"),d3.select("#graphWidthLower").attr("disabled","disabled"),
d3.select("#graphWidthHigher").attr("disabled","disabled"));xa()});d3.select("#graphWidthLower").on("click",function(){a.graphWidth-=a.graphWidthStep;a.graphWidth<a.graphWidthStep&&(a.graphWidth=a.graphWidthStep);C()});d3.select("#graphWidthHigher").on("click",function(){a.graphWidth+=a.graphWidthStep;C()});phyd3.phylogram.renderPNG=function(){var a=phyd3.phylogram.getSVGData(),b=document.createElement("canvas");d3.select("g#main").node().getBBox();canvg(b,a);b.toBlob(function(a){saveAs(a,"phylogram.png")})};
d3.select("#searchQuery").on("change",function(){Aa()});d3.select("#applyTaxonomyColors").on("click",function(){d3.selectAll("input.taxColor").each(function(a){b.taxcolors[a.taxonomy].color=jQuery(this).val()});jQuery("#taxonomyColorsModal").modal("hide");da()});d3.select("#applyGroupLabel").on("click",function(){var a=jQuery("#groupID").val(),d=jQuery("#groupDepth").val(),e=jQuery("#groupLabel").val(),f=jQuery("#groupLabelBackground").val(),h=jQuery("#groupLabelForeground").val();jQuery("#groupLabelModal").modal("hide");
b.groups[a]={id:a,depth:d,label:e,foregroundColor:h,backgroundColor:f};ia(b,a);F();S()});d3.select("#clearGroupLabel").on("click",function(){var a=jQuery("#groupID").val();jQuery("#groupLabelModal").modal("hide");delete b.groups[a];va(b,a);F()});H=function(){var a=[],d;for(d in b.taxcolors){var e=b.taxcolors[d];e.taxonomy=d;a.push(e)}return a}();H.length?(H=d3.select("#taxonomyColorsList").selectAll("div.taxColor").data(H).enter().append("div").attr("class","form-group col-xs-4 taxColor"),H.append("label").attr("class",
"col-xs-4 control-label").text(function(a){return a.taxonomy}),H=H.append("div").attr("class","col-xs-8").append("div").attr("class","input-group colorpicker-component"),H.append("input").attr("class","form-control taxColor").attr("type","text").attr("value",function(a){return a.color.replace("0x","#")}),H.append("span").attr("class","input-group-btn").append("span").attr("class","input-group-addon btn btn-fab btn-fab-mini").append("i"),jQuery(".colorpicker-component").colorpicker(),jQuery("#taxonomyColorsModal").on("hide.bs.modal",
function(){jQuery(".colorpicker-component").colorpicker("hide")}),jQuery("#groupLabelModal").on("hide.bs.modal",function(){jQuery(".colorpicker-component").colorpicker("hide")})):d3.select("#taxonomyColorsList").append("div").attr("class","col-sm-12 text-center").text("No taxonomy information available");F();phyd3.phylogram.genpng_static=function(a){var b=document.createElement("canvas");canvg(b,a);console.log("genpng_static");b.toBlob(function(a){var b=new FileReader;b.readAsDataURL(a);console.log("blob.size",
a.size);b.onloadend=function(){var a=b.result;console.log("base64data.length",a.length);window.png_callback(a.substr(a.indexOf(",")+1))}})};phyd3.phylogram.doFullRepaint=F;phyd3.phylogram.getSVGData=function(){var b=d.querySelector("svg"),e=b.getElementById("main"),f=e.getBBox();e=e.getAttributeNode("transform");var k=b.getAttributeNode("width"),h=b.getAttributeNode("height"),m=e.value,n=k.value,q=h.value;e.value="translate("+(20-f.x)+", "+(20-f.y)+")";k.value=(Math.max(+k.value.replace("px",""),
f.width)+a.marginX).toString();h.value=(Math.max(+h.value.replace("px",""),f.height)+a.marginY).toString();if(window.XMLSerializer)var t=(new XMLSerializer).serializeToString(b);else b.xml&&(t=b.xml);e.value=m;k.value=n;h.value=q;return t}}})();
...
d.getElementsByTagName("red")[0];b=b?parseInt(b.textContent):0;var a=d.getElementsByTagName("greeen")[0];a=a?parseInt(a.textContent):0;var e=d.getElementsByTagName("blue")[0];e=e?parseInt(e.textContent):0;d=(d=d.getElementsByTagName("alpha")[0])?parseInt(d.textContent):255;return"rgba("+b+","+a+","+e+", "+parseFloat(d/255)+")"};phyd3.phyloxml.parseDomainArchitecture=function(d){var b={sequenceLength:parseInt(d.getAttribute("length")),domains:[]};d=d.getElementsByTagName("domain");for(var a=0;a<d.length;a++){var e=
d[a];b.domains.push({confidence:parseFloat(e.getAttribute("confidence")),from:parseInt(e.getAttribute("from")),to:parseInt(e.getAttribute("to")),id:e.getAttribute("id"),name:e.textContent})}return b};phyd3.phyloxml.parseCrossReferences=function(d){var b=[];d=d.getElementsByTagName("accession");for(var a=0;a<d.length;a++)b.push(phyd3.phyloxml.parseAccession(d[a]));return b};phyd3.phyloxml.parseEvents=function(d){for(var b={},a=0;a<d.childNodes.length;a++){var e=d.childNodes[a];switch(e.nodeName){case "type":b.type=
...
break;case "confidence":b.confidences.push(phyd3.phyloxml.parseConfidence(e));break;case "sequence":b.sequences.push(phyd3.phyloxml.parseSequence(e));break;case "color":b.color=phyd3.phyloxml.parseColor(e);break;case "events":b.events=phyd3.phyloxml.parseEvents(e);break;case "id":case "name":b[e.nodeName]=e.textContent;break;case "#text":case "#comment":break;default:b[e.nodeName]=e.textContent}}b.id||(phyd3.phyloxml.cid++,b.id="_"+phyd3.phyloxml.cid);return b};phyd3.phyloxml.parseLegend=function(d){for(var b=
{show:parseInt(d.getAttribute("show")),stacked:parseInt(d.getAttribute("stacked")),fields:[],gradient:{}},a=d.getElementsByTagName("field"),e=0;e<a.length;e++){var f=a[e],n=f.getElementsByTagName("name")[0];n=n?n.textContent:"";var k=f.getElementsByTagName("color")[0];k=k?k.textContent:"";var q=f.getElementsByTagName("background")[0];q=q?q.textContent:"";var x=f.getElementsByTagName("orthoid")[0];x=x?x.textContent:"";var I=f.getElementsByTagName("shape")[0];I=I?I.textContent:"";f=(f=f.getElementsByTagName("url")[0])?
f.textContent:"";b.fields.push({name:n,color:k,background:q,orthoid:x,shape:I,url:f})}if(d=d.getElementsByTagName("gradient")[0])n=(n=d.getElementsByTagName("name")[0])?n.textContent:"",d=(d=d.getElementsByTagName("classes")[0])?parseInt(d.textContent):0,b.gradient={name:n,classes:d};return b};phyd3.phyloxml.parseData=function(d){var b={tag:d.getAttribute("tag"),ref:d.getAttribute("ref")},a=d.getElementsByTagName("min")[0];b.min=a?a.textContent:void 0;a=d.getElementsByTagName("max")[0];b.max=a?a.textContent:
void 0;d=d.getElementsByTagName("values");for(a=0;a<d.length;a++){var e=d[a].getAttribute("for"),f=d[a].getElementsByTagName("value");b[e]=[];for(var n=0;n<f.length;n++)b[e].push({value:parseFloat(f[n].textContent),label:f[n].getAttribute("label")||""})}return b};phyd3.phyloxml.parseGraph=function(d){for(var b={name:"",legend:{},data:{},type:d.getAttribute("type")},a=0;a<d.childNodes.length;a++){var e=d.childNodes[a];switch(e.nodeName){case "name":b.name=e.textContent;break;case "legend":b.legend=
phyd3.phyloxml.parseLegend(e);break;case "data":b.data=phyd3.phyloxml.parseData(e);break;case "#text":case "#comment":break;default:console.log("Undefined tag: "+e.nodeName+" "+e.textContent+" - skipping...")}}return b};phyd3.phyloxml.parseLabel=function(d){for(var b={showLegend:!1,name:"",data:{},type:d.getAttribute("type")},a=0;a<d.childNodes.length;a++){var e=d.childNodes[a];switch(e.nodeName){case "name":b.name=e.textContent;b.showLegend=e.getAttribute("show");break;case "data":b.data=phyd3.phyloxml.parseData(e);
break;case "#text":case "#comment":break;default:console.log("Undefined tag: "+e.nodeName+" "+e.textContent+" - skipping...")}}return b};phyd3.phyloxml.parse=function(d){var b={branchset:[],properties:[],confidence:[]},a=d.getElementsByTagName("phylogeny");a=a[0];b.rooted=a.getAttribute("rooted");b.rerootable=a.getAttribute("rerootable");b.branch_length_unit=a.getAttribute("branch_length_unit");b.type=a.getAttribute("type");if(a&&a.childNodes)for(var e=0;e<a.childNodes.length;e++){var f=a.childNodes[e];
switch(f.nodeName){case "clade":b.branchset.push(phyd3.phyloxml.parseClade(f));break;case "confidence":b.confidence.push(phyd3.phyloxml.parseConfidence(f));break;case "date":b.date=f.textContent;break;case "description":b.description=f.textContent;break;case "id":b.id=f.textContent;break;case "name":b.name=f.textContent;break;case "property":b.properties.push(phyd3.phyloxml.parseProperty(f));break;case "#text":case "#comment":break;default:console.log("Undefined tag: "+f.nodeName+" "+f.textContent+
" - skipping...")}}a=d.getElementsByTagName("taxonomies");a=a[0];var n={};if(a&&a.childNodes)for(e=0;e<a.childNodes.length;e++){var k=a.childNodes[e];if("color"==k.nodeName){f=k.getElementsByTagName("code")[0].textContent;var q=k.getElementsByTagName("value")[0].textContent;n[f]={color:q}}if("taxonomy"==k.nodeName){f=k.getAttribute("code");q=(q=k.getElementsByTagName("color")[0])?q.textContent:q;var x=k.getElementsByTagName("name")[0];x=x?x.textContent:x;k=(k=k.getElementsByTagName("url")[0])?k.textContent:
k;n[f]={color:q,name:x,url:k}}}b.taxcolors=n;a=d.getElementsByTagName("domains");a=a[0];n={};if(a&&a.childNodes)for(e=0;e<a.childNodes.length;e++)k=a.childNodes[e],"color"==k.nodeName&&(f=k.getElementsByTagName("code")[0].textContent,q=k.getElementsByTagName("value")[0].textContent,n[f]={color:q}),"domain"==k.nodeName&&(f=k.getAttribute("name"),q=(q=k.getElementsByTagName("color")[0])?q.textContent:q,x=(x=k.getElementsByTagName("description")[0])?x.textContent:x,k=(k=k.getElementsByTagName("url")[0])?
k.textContent:k,n[f]={color:q,description:x,url:k});b.domcolors=n;a=d.getElementsByTagName("graphs");a=a[0];f=[];if(a&&a.childNodes)for(e=0;e<a.childNodes.length;e++)q=a.childNodes[e],"graph"==q.nodeName&&f.push(phyd3.phyloxml.parseGraph(q));b.graphs=f;a=d.getElementsByTagName("labels");a=a[0];d=[];if(a&&a.childNodes)for(e=0;e<a.childNodes.length;e++)f=a.childNodes[e],"label"==f.nodeName&&d.push(phyd3.phyloxml.parseLabel(f));b.labels=d;return b}})();
/* Blob.js
...
var colorbrewer = {
Custom: {
2: ["#170a1c","#228cdb"], // normal: "0", "1"
4: ["#666666","#170a1c","#f72585","#228cdb"]  // blast: "0" (not yet blasted), blasted negative, blasted positive, "1"
},YlGn: {
